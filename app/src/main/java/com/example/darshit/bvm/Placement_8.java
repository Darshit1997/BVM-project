...
public class Placement_8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placement_8);
        ...
        web1.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.bvmengineering.ac.in/Placement%20Details%20of%20Past%20Years/Placement_2015-16.pdf");
