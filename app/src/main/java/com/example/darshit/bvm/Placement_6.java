...
public class Placement_6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placement_6);
        ...
        web1.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.bvmengineering.ac.in/Placement%20Details%20of%20Past%20Years/2_placement_record_final_2013-14.pdf");
