...
public class Placement_7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placement_7);
        ...
        web1.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.bvmengineering.ac.in/Placement%20Details%20of%20Past%20Years/2_placementrecords%202014-15_2.pdf");
