...
public class Placement_10 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placement_10);
        ...
        web1.loadUrl("http://docs.google.com/gview?embedded=true&url=http://bvmengineering.ac.in/Placement%20Details%20of%20Past%20Years/Placement_2017-18.pdf");
