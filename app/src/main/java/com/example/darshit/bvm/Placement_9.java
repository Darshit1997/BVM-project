...
public class Placement_9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_placement_9);
        ...
        web1.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.bvmengineering.ac.in//Placement%20Details%20of%20Past%20Years/Placement_2016-17.pdf");
